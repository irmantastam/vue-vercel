...
/** To have author-related properties [See type definition](https://app.contentful.com/spaces/pimw4pk59p47/content_types/componentAuthor) */
...
/** To describe an image used in rich text fields [See type definition](https://app.contentful.com/spaces/pimw4pk59p47/content_types/componentRichImage) */
...
export type ComponentRichImageLinkingCollectionsPageLandingCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  order?: InputMaybe<Array<InputMaybe<ComponentRichImageLinkingCollectionsPageLandingCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
};

export enum ComponentRichImageLinkingCollectionsPageLandingCollectionOrder {
...
/** To have SEO-related properties to the pages we render [See type definition](https://app.contentful.com/spaces/pimw4pk59p47/content_types/componentSeo) */
...
/** To create individual blog posts [See type definition](https://app.contentful.com/spaces/pimw4pk59p47/content_types/pageBlogPost) */
...
/** To have an entry point for the app (e.g. Homepage) [See type definition](https://app.contentful.com/spaces/pimw4pk59p47/content_types/pageLanding) */
export type PageLanding = Entry & {
  ...
  image?: Maybe<ComponentRichImage>;
  internalName?: Maybe<Scalars['String']>;
...
/** To have an entry point for the app (e.g. Homepage) [See type definition](https://app.contentful.com/spaces/pimw4pk59p47/content_types/pageLanding) */
export type PageLandingImageArgs = {
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
...
export type PageLandingFilter = {
  ...
  image?: InputMaybe<CfComponentRichImageNestedFilter>;
  image_exists?: InputMaybe<Scalars['Boolean']>;
  internalName?: InputMaybe<Scalars['String']>;
  internalName_contains?: InputMaybe<Scalars['String']>;
  internalName_exists?: InputMaybe<Scalars['Boolean']>;
...
export type PageLandingFieldsFragment = { __typename: 'PageLanding', internalName?: string | null, greeting?: string | null, sys: { __typename?: 'Sys', id: string, spaceId: string }, seoFields?: (
    ...
    { __typename?: 'ComponentRichImage' }
    & RichImageFieldsFragment
  ) | null, content?: { __typename?: 'PageLandingContent', json: any, links: { __typename?: 'PageLandingContentLinks', entries: { __typename?: 'PageLandingContentEntries', block: Array<{ __typename?: 'ComponentAuthor' } | (
          { __typename?: 'ComponentRichImage' }
          & RichImageFieldsFragment
        ) | { __typename?: 'ComponentSeo' } | { __typename?: 'PageBlogPost' } | { __typename?: 'PageLanding' } | null> } } } | null };
